!function (t, e) {
    ...
    return function () {
        ...
        var t = {
            7621: function (t, e, i) {
                var s = i(8081), a = i.n(s), n = i(3645), o = i.n(n), r = i(1667), l = i.n(r),
                    c = new URL(i(6468), i.b), u = o()(a()), d = l()(c);
                ...
                t.exports = function (t) {
                    ...
                    return e.toString = function () {
                        ...
                        var o = {};
                        if (s) for (var r = 0; r < this.length; r++) {
                            var l = this[r][0];
                            null != l && (o[l] = !0)
                        }
                        for (var c = 0; c < t.length; c++) {
                            var u = [].concat(t[c]);
                            s && o[u[0]] || (void 0 !== n && (void 0 === u[5] || (u[1] = "@layer".concat(u[5].length > 0 ? " ".concat(u[5]) : "", " {").concat(u[1], "}")), u[5] = n), i && (u[2] ? (u[1] = "@media ".concat(u[2], " {").concat(u[1], "}"), u[2] = i) : u[2] = i), a && (u[4] ? (u[1] = "@supports (".concat(u[4], ") {").concat(u[1], "}"), u[4] = a) : u[4] = "".concat(a)), e.push(u))
                        }
                    }, e
                }
            }, 1667: function (t) {
                ...
                function i(t) {
                    for (var i = -1, s = 0; s < e.length; s++) if (e[s].identifier === t) {
                        i = s;
                        break
                    }
                    return i
                ...
                function s(t, s) {
                    for (var n = {}, o = [], r = 0; r < t.length; r++) {
                        var l = t[r], c = s.base ? l[0] + s.base : l[0], u = n[c] || 0, d = "".concat(c, " ").concat(u);
                        n[c] = u + 1;
                        var m = i(d), h = {css: l[1], media: l[2], sourceMap: l[3], supports: l[4], layer: l[5]};
                        if (-1 !== m) e[m].references++, e[m].updater(h); else {
                            var p = a(h, s);
        ...
        return function () {
            ...
            var t = i(3379), e = i.n(t), a = i(7795), n = i.n(a), o = i(569), r = i.n(o), l = i(3565), c = i.n(l),
                u = i(9216), d = i.n(u), m = i(4589), h = i.n(m), p = i(7621), y = {};
            ...
            function v(t, e) {
                for (var i = 0; i < e.length; i++) {
                    var s = e[i];
                    s.enumerable = s.enumerable || !1, s.configurable = !0, "value" in s && (s.writable = !0), Object.defineProperty(t, g(s.key), s)
                }
            }
            ...
            var b,
                ...
                S = ["light", "dark", "system"], x = ["sticky", "static", "hidden"],
            ...
            var w = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
                ...
                C = "rtl" === document.documentElement.getAttribute("dir"), T = !!z.contains("layout-menu-collapsed"),
                L = b, N = z.contains("layout-wide") ? "wide" : "compact", A = !!z.contains("layout-footer-fixed"),
                ...
                E = function () {
                    function t(e) {
                        var i = e.cssPath, s = e.themesPath, a = e.cssFilenamePattern, n = e.displayCustomizer,
                            o = e.controls, r = e.defaultTextDir, l = e.defaultHeaderType, c = e.defaultContentLayout,
                            u = e.defaultMenuCollapsed, d = e.defaultShowDropdownOnHover, m = e.defaultNavbarType,
                            h = e.defaultFooterFixed, p = e.styles, y = e.navbarOptions, f = e.defaultStyle,
                            v = e.availableContentLayouts, g = e.availableDirections, b = e.availableStyles,
                            z = e.availableThemes, E = e.availableLayouts, I = e.availableHeaderTypes,
                        ...
                        if (function (t, e) {
                            ...
                            if (this.settings = {}, this.settings.cssPath = i, this.settings.themesPath = s, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === n || n, this.settings.controls = o || _, this.settings.defaultTextDir = "rtl" === r || C, this.settings.defaultHeaderType = l || O, this.settings.defaultMenuCollapsed = void 0 !== u ? u : T, this.settings.defaultContentLayout = void 0 !== c ? c : N, this.settings.defaultShowDropdownOnHover = void 0 === d || d, this.settings.defaultNavbarType = void 0 !== m ? m : L, this.settings.defaultFooterFixed = void 0 !== h ? h : A, this.settings.availableDirections = g || t.DIRECTIONS, this.settings.availableStyles = b || t.STYLES, this.settings.availableThemes = z || t.THEMES, this.settings.availableHeaderTypes = I || t.HEADER_TYPES, this.settings.availableContentLayouts = v || t.CONTENT, this.settings.availableLayouts = E || t.LAYOUTS, this.settings.availableNavbarOptions = F || t.NAVBAR_OPTIONS, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== D ? D : w), this.settings.styles = p || S, this.settings.navbarOptions = y || x, this.settings.defaultStyle = f || k, this.settings.lang = M || "en", this.pathResolver = q || function (t) {
                                return t
                    ...
                    return e = t, i = [{
                        ...
                        key: "setTheme", value: function (t) {
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                if (s) {
                                    this.settings.theme = s, e && this._setSetting("Theme", t);
                                    var a, n, o,
                                    ...
                                    this._loadStylesheets((a = {}, n = r, o = document.querySelector(".template-customizer-theme-css"), (n = g(n)) in a ? Object.defineProperty(a, n, {
                                        value: o,
                                        enumerable: !0,
                                        configurable: !0,
                                        writable: !0
                        ...
                        key: "setLayoutType", value: function (t) {
                            ...
                            if (this._hasControls("headerType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                                ...
                                var i = window.Helpers.menuPsScroll, s = window.PerfectScrollbar;
                                "fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType ? s && i && (window.Helpers.menuPsScroll.destroy(), i = new s(document.querySelector(".menu-inner"), {
                                    suppressScrollX: !0,
                                    wheelPropagation: !1
                        ...
                        key: "setLang", value: function (e) {
                            ...
                            if (e !== this.settings.lang || a) {
                                ...
                                this.settings.lang = e, s && this._setSetting("Lang", e), s && this.settings.onSettingsChange.call(this, this.settings)
                            }
                        }
                    }, {
                        key: "update", value: function () {
                            if (!this._ssr) {
                                var t = !!document.querySelector(".layout-navbar"),
                                    ...
                                    s = (document.querySelector(".layout-wrapper.layout-navbar-full"), !!document.querySelector(".content-footer"));
                        ...
                        key: "_loadSettings", value: function () {
                            var t, e, i = this._getSetting("Rtl"), s = this._getSetting("Style"),
                                a = this._getSetting("Theme"), n = this._getSetting("contentLayout"),
                        ...
                        key: "_setup", value: function () {
                            ...
                            var a = this.container.querySelector(".template-customizer-open-btn"), n = function () {
                            ...
                            a.addEventListener("click", n), this._listeners.push([a, "click", n]);
                            var o = this.container.querySelector(".template-customizer-reset-btn"), r = function () {
                                t.clearLocalStorage(), window.location.reload()
                            };
                            o.addEventListener("click", r), this._listeners.push([o, "click", r]);
                            var l = this.container.querySelector(".template-customizer-close-btn"), c = function () {
                            ...
                            if (this._hasControls("style")) {
                                this.settings.availableStyles.forEach((function (t) {
                                    ...
                                    typeof e === 'object' && d.appendChild(e)
                            ...
                            if (this._hasControls("themes")) {
                                this.settings.availableThemes.forEach((function (t) {
                                    ...
                                    typeof s === "object" && p.appendChild(s)
                            ...
                            if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                                ...
                                if (this._hasControls("rtl") && rtlSupport) {
                                    ...
                                    this.settings.availableDirections.forEach((function (t) {
                                        ...
                                        typeof e === "object" && b.appendChild(e)
                                    })), b.querySelector('input[value="'.concat(this.settings.rtl ? "rtl" : "ltr", '"]'))?.setAttribute("checked", "checked");
                                    var _ = function (e) {
                                        t._loadingState(!0), t._setSetting("Lang", t.settings.lang), "ar" === t._getSetting("Lang") ? t._setSetting("Lang", "en") : t._setSetting("Lang", "ar"), t.setRtl("rtl" === e.target.value, !0, (function () {
                                            t._loadingState(!1)
                                        }))
                                    };
                                ...
                                if (this._hasControls("headerType")) {
                                    ...
                                    setTimeout((function () {
                                        ...
                                        typeof e === "object" && w.appendChild(e)
                                ...
                                if (this._hasControls("contentLayout")) {
                                    ...
                                    this.settings.availableContentLayouts.forEach((function (t) {
                                        ...
                                        typeof e === "object" && T.appendChild(e)
                                ...
                                if (this._hasControls("layoutCollapsed")) {
                                    ...
                                    this.settings.availableLayouts.forEach((function (t) {
                                        ...
                                        typeof e === "object" && A.appendChild(e)
                                ...
                                if (this._hasControls("layoutNavbarOptions")) {
                                    ...
                                    this.settings.availableNavbarOptions.forEach((function (t) {
                                        ...
                                        typeof e === "object" && I.appendChild(e)
                        ...
                        key: "_insertStylesheet", value: function (t, e) {
                            ...
                            if ("number" == typeof document.documentMode && document.documentMode < 11) {
                                ...
                                s.setAttribute("rel", "stylesheet"), s.setAttribute("type", "text/css"), s.className = t, s.setAttribute("href", e), i.parentNode.insertBefore(s, i.nextSibling)
                        ...
                        key: "_loadStylesheets", value: function (t, e) {
                            var i = Object.keys(t), s = i.length, a = 0;

                            function n(t, e, i) {
                                var s = document.createElement("link");
                                s.setAttribute("href", t), s.setAttribute("rel", "stylesheet"), s.setAttribute("type", "text/css"), s.className = e.className;
                                var a, n = "sheet" in s ? "sheet" : "styleSheet",
                                    o = "sheet" in s ? "cssRules" : "rules", r = setTimeout((function () {
                                        clearInterval(a), clearTimeout(r), e.parentNode.removeChild(s), i(!1, t)
                                    }), 15e3);
                                a = setInterval((function () {
                                    try {
                                        s[n] && s[n][o].length && (clearInterval(a), clearTimeout(r), e.parentNode.removeChild(e), i(!0))
                                    } catch (t) {
                                    }
                                }), 10), e.parentNode.insertBefore(s, e.nextSibling)
                            }

                            for (var o = 0; o < i.length; o++) n(i[o], t[i[o]], void ((a += 1) >= s && e()))
                        }
                    }, {
                        ...
                        key: "_hasControls", value: function (t) {
                            ...
                            return t.split(" ").reduce((function (t, s) {
                                return -1 !== e.settings.controls.indexOf(s) ? (i || !1 !== t) && (t = !0) : i && !0 === t || (t = !1), t
                            }), null)
                        }
                    }, {
                        ...
                        key: "_getThemeByName", value: function (t) {
                            for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = this.settings.availableThemes, s = 0, a = i.length; s < a; s++) if (i[s].name === t) return i[s];
                            return e ? this.settings.defaultTheme : null
                        }
                    }], i && v(e.prototype, i), Object.defineProperty(e, "prototype", {writable: !1}), t
                }();
            E.STYLES = [{name: "light", title: "Light"}, {name: "dark", title: "Dark"}, {
                name: "system",
                title: "System"
            }], E.THEMES = [{name: "theme-default", title: "Default"}, {
                name: "theme-bordered",
                title: "Bordered"
            }, {name: "theme-semi-dark", title: "Semi Dark"}], E.LAYOUTS = [{
                name: "expanded",
                title: "Expanded"
            }, {name: "collapsed", title: "Collapsed"}], E.NAVBAR_OPTIONS = [{
                name: "sticky",
                title: "Sticky"
            }, {name: "static", title: "Static"}, {name: "hidden", title: "Hidden"}], E.HEADER_TYPES = [{
                name: "fixed",
                title: "Fixed"
            }, {name: "static", title: "Static"}], E.CONTENT = [{name: "compact", title: "Compact"}, {
                name: "wide",
                title: "Wide"
            }], E.DIRECTIONS = [{name: "ltr", title: "Left to Right (En)"}, {
                name: "rtl",
